...
const ChatRightPart = ({ sellerId, setShow, show, dontShow, name }) => {
  return (
    <div>
      <div className="flex justify-between items-center">
        {sellerId && (
          <div className="flex justify-start items-center gap-3">
            ...
            :
            <h2 className="text-md font-semibold text-white">Ibrahim</h2>
            }
          </div>
        )}
        ...
        {dontShow ?
            ...
            className="w-[35px] flex md:hidden h-[35px] rounded-sm bg-[#287999] shadow-lg hover:shadow-blue-500/50 justify-center items-center cursor-pointer text-white"
        >
            <span>
            <FaList />
            </span>
